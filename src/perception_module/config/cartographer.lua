...
TRAJECTORY_BUILDER_2D.min_range = 1.0  -- Ignore very close points (could be car body)
TRAJECTORY_BUILDER_2D.max_range = 25.0  -- Extend range for racing
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(1.0)  -- Tune for racing speeds
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.1  -- Tune for racing speeds
...
POSE_GRAPH.optimize_every_n_nodes = 20  -- Smaller value for more frequent optimizations
POSE_GRAPH.constraint_builder.min_score = 0.55
POSE_GRAPH.optimization_problem.huber_scale = 1e1
POSE_GRAPH.constraint_builder.sampling_ratio = 0.3  -- Sample fewer constraints for performance
POSE_GRAPH.global_sampling_ratio = 0.1  -- Sample fewer nodes for global search
POSE_GRAPH.max_num_final_iterations = 10  -- More iterations for better quality
POSE_GRAPH.global_constraint_search_after_n_seconds = 5.0  -- More frequent global searches

-- Tune based on your environment
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 50  -- Fewer range data for faster submap creation
